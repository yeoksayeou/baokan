...
window.SITE_INFO = {
    ...
    that are not in the repository with transcribed articles this used.</p><p>There may also have been problems with the automatic translation. 
    Besides missing issues, keep an eye out for missing articles in the translation of 
    some issues due to errors in the translation process when breaking up large issues into smaller pieces. Comparing the small article numbers after article headlines in the translation and original can help alert you to missing content. More years (including various locations the newspaper was published in 1938) may be added later.</p>
